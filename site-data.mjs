...
export default {
  ...
  serviceCategories: [
    ...
    },
    {
      ...
      label: "Обучение",
      items: [
        service("Курс аппаратный маникюр «Идеальная…»", "10 000 ₽", "12 ч", "Полный курс для новичков и мастеров с опытом (повышение…)"),
        service("Базовый курс маникюра с нуля для новичков", "35 000 ₽", "3 д", "Полный базовый курс маникюра с нуля для новичков."),
        service("Курсы повышения квалификации для мастеров с опытом", "15 000 ₽", "1 д", "Анализ работ мастера, работа над ошибками с отработкой, закрыти…"),
      ],
    },
  ],
