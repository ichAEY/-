...
export default {
  ...
  master: {
    ...
    highlightSkill: "Обучение мастеров",
  },
  ...
  images: {
    portrait: "/assets/client/hero.png",
    about: "/assets/client/about.png",
    favicon: "/assets/client/hero.png",
    beforeAfter: [],
  ...
  serviceCategories: [
    ...
    },
    {
      ...
      label: "Обучение",
      items: [
        service("Курс аппаратный маникюр «Идеальная кутикула без пропилов»", "10 000 ₽", "12 ч", "Полный курс для новичков и мастеров с опытом (повышение квалификации). Идеальная кутикула без режущих инструментов. «Нет пропилам и заусенцам!»"),
        service("Базовый курс маникюра с нуля для новичков.", "35 000 ₽", "3 д", "Полный базовый курс маникюра с нуля для новичков."),
        service("Курсы повышения квалификации для мастеров с опытом", "15 000 ₽", "1 д", "Анализ работ мастера, работа над ошибками с отработкой, закрытие пробелов в работе мастера."),
      ],
    },
  ],

  reviews: [
    { text: "Очень аккуратный и красивый маникюр, долго носится, Алла отличный мастер. Студия очень уютная 🥰", author: "Анастасия Ильченко" },
    { text: "Очень аккуратный маникюр. Чистота, порядок, большая палитра цветов, мой любимый идеальный френч. Рекомендую.", author: "Облака" },
    { text: "Делал у Аллы педикюр: очень качественно, я доволен! А ещё мастер обаятельна и окружает вниманием. Спасибо, обязательно приду скоро вновь.", author: "Din Vinus" },
    { text: "Мастер супер, идеально сделала маникюр и педикюр. Очень всё понравилось.", author: "Valeriy Grachev" },
    { text: "Красивый аккуратный маникюр . Рекомендую .", author: "Наталья П." },
    { text: "Делал у Аллы мужской маникюр. Рекомендую.", author: "Артур Ж." },
  ],

  promotions: [],

  amenitiesHeading: {
    title: "Почему выбирают Аллу",
    note: "Главное перед записью",
  },
